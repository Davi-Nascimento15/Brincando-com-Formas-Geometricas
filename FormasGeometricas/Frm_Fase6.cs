...
{
    public partial class Frm_Fase6 : Form
    {
        int interações;
        int acertos;
        int erros;
        ...
        PictureBox PB;
        Jogador jogador;
        public Frm_Fase6(Jogador jogador)
        {
        ...
        private void Frm_Fase6_Load(object sender, EventArgs e)
        {
            tempo_Fase.Start();
            tempo_Dicas.Start();
            Fundo.Play();
        ...
        private void Confere(PictureBox P, int S)
        {
            ...
            if (interações == 0)
            {
                ...
                Frm_Conclusao Final = new Frm_Conclusao(jogador);
                Frm_Carregando C = new Frm_Carregando(Final);
                Fundo.Stop();
                Fundo.Dispose();
                C.ShowDialog();
                Close();
        ...
        {
            pb_CirculoBranco1.BackgroundImage = Properties.Resources.Quadra;
            pb_CirculoBranco2.BackgroundImage = Properties.Resources.Quadra;
            pb_RetanguloBranco1.BackgroundImage = Properties.Resources.Quadra;
