...
namespace FormasGeometricas
{
    public partial class Frm_Fase3 : Form
    {
        ...
        PictureBox PB;
        Jogador jogador;
        public Frm_Fase3(Jogador jogador)
        {
        ...
        private void Frm_Fase3_Load(object sender, EventArgs e)
        {
            tempo_Fase.Start();
            tempo_Dicas.Start();
            Fundo.Play();
        ...
        private void Confere(PictureBox P, int S)
        {
            ...
            if (Lista.Find(x => x.Contains(P.Name)) == null)
            {
                ...
                {
                    P.Image = PB.Image;
                    if (PB.Name == "pb_Triangulo")
                    {
                        PB.Image = Properties.Resources.TrianguloFase3Colorido;
                    }
                    Lista.Add(P.Name);
            ...
            if (interações == 0)
            {
                ...
                Frm_Fase4 F4 = new Frm_Fase4(jogador);
                Frm_Carregando C = new Frm_Carregando(F4);
                Fundo.Stop();
                C.ShowDialog();
                Close();
            }
        ...
        private void pb_RetanguloBranco4_Click(object sender, EventArgs e)
        {
            Confere(pb_RetanguloBranco4, 12);
        }

        private void pb_RetanguloBranco5_Click(object sender, EventArgs e)
        {
            Confere(pb_RetanguloBranco5, 12);
        }
        ...
        private void pb_TrianguloBranco1_Click(object sender, EventArgs e)
        {
            if (PB.Name == "pb_Triangulo")
            {
                PB.Image = Properties.Resources.TrianguloFrenteColorido;
            }
        ...
        {
            pb_CirculoBranco8.BackColor = Color.Blue;
            Confere(pb_CirculoBranco1, 10);
        }

        private void pb_CirculoBranco2_Click(object sender, EventArgs e)
        {
            pb_CirculoBranco9.BackColor = Color.Blue;
            Confere(pb_CirculoBranco2, 10);
        }

        private void pb_CirculoBranco3_Click(object sender, EventArgs e)
        {
            pb_CirculoBranco10.BackColor = Color.Blue;
            Confere(pb_CirculoBranco3, 10);
        }

        private void pb_CirculoBranco4_Click(object sender, EventArgs e)
        {
            pb_CirculoBranco11.BackColor = Color.Blue;
            Confere(pb_CirculoBranco4, 10);
        }

        private void pb_CirculoBranco5_Click(object sender, EventArgs e)
        {
            pb_CirculoBranco12.BackColor = Color.Blue;
            Confere(pb_CirculoBranco5, 10);
        }

        private void pb_CirculoBranco6_Click(object sender, EventArgs e)
        {
            pb_CirculoBranco13.BackColor = Color.Blue;
            Confere(pb_CirculoBranco6, 10);
        }

        private void pb_CirculoBranco7_Click(object sender, EventArgs e)
        {
            pb_CirculoBranco15.BackColor = Color.Blue;
            Confere(pb_CirculoBranco7, 10);
        }

        private void pb_CirculoBranco8_Click(object sender, EventArgs e)
        {
            Confere(pb_CirculoBranco8, 10);
        }

        private void pb_CirculoBranco9_Click(object sender, EventArgs e)
        {
            Confere(pb_CirculoBranco9, 10);
        }

        private void pb_CirculoBranco10_Click(object sender, EventArgs e)
        {
            Confere(pb_CirculoBranco10, 10);
        }

        private void pb_CirculoBranco11_Click(object sender, EventArgs e)
        {
                Confere(pb_CirculoBranco11, 10);   
        }

        private void pb_CirculoBranco12_Click(object sender, EventArgs e)
        {
            Confere(pb_CirculoBranco12, 10);
        }
        private void pb_CirculoBranco13_Click(object sender, EventArgs e)
        {
            Confere(pb_CirculoBranco13, 10);
        }
        private void pb_CirculoBranco15_Click(object sender, EventArgs e)
        {
            Confere(pb_CirculoBranco15, 10);
        }
    }
}
