...
namespace FormasGeometricas
{
    public partial class Frm_Fase4 : Form
    {
        ...
        PictureBox PB;
        Jogador jogador;
        public Frm_Fase4(Jogador jogador)
        {
        ...
        private void Frm_Fase4_Load(object sender, EventArgs e)
        {
            tempo_Fase.Start();
            tempo_Dicas.Start();
            Fundo.Play();
        ...
        private void Confere(PictureBox P, int S)
        {
            ...
            if (interações == 0)
            {
                ...
                Frm_Fase5 F5 = new Frm_Fase5(jogador);
                Frm_Carregando C = new Frm_Carregando(F5);
                Fundo.Stop();
                C.ShowDialog();
                Close();
            }
