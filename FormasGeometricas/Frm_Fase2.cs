...
{
    public partial class Frm_Fase2 : Form
    {
        int interações;
        int acertos;
        int erros;
        ...
        PictureBox PB;
        Jogador jogador;
        public Frm_Fase2(Jogador jogador)
        {
        ...
        private void Frm_Fase2_Load(object sender, EventArgs e)
        {
            timer_Fase.Start();
            tempo_Dicas.Start();
            Fundo.Play();
        }
        private void timer_Fase_Tick(object sender, EventArgs e)
        {
            TempoFase();
        }
        ...
        private void Confere(PictureBox P, int S)
        {
            ...
            if (interações == 0)
            {
                ...
                Frm_Fase3 F3 = new Frm_Fase3(jogador);
                Frm_Carregando C = new Frm_Carregando(F3);
                Fundo.Stop();
                C.ShowDialog();
                Close();
            }
        ...
        private void pb_RetanguloBranco6_Click(object sender, EventArgs e)
        {
            Confere(pb_RetanguloBranco6, 12);
        }
        ...
        private void pb_QuadradoBranco5_Click(object sender, EventArgs e)
        {
            Confere(pb_QuadradoBranco5, 11);
        }

        private void pb_QuadradoBranco6_Click(object sender, EventArgs e)
        {
            Confere(pb_QuadradoBranco6, 11);
        }
